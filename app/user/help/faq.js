...
app.controller('FAQCtrl', function($scope, $location, $anchorScroll, $sce, dataService) {
    ...
    $scope.faq = {
        ...
        },
        {
            ...
            answer: $sce.trustAsHtml("You can start mining today if you have a computer that sits idle. GRAFT can be mined on CPUs, GPU's or even a raspberry PI. To start mining you need to find the right mining software for your hardware and get going.<br/><br/>Read <a hred='#/help/getting_started'>Getting Started</a> for more details.")
        },
        {
        ...
        },
        {
            ...
            answer: $sce.trustAsHtml("Payout threshold is the minimum amount that needs to be earned before the pool pays out to your wallet. Since transactions in GRAFT have a significant miner fees, it's cost effective to set a higher payout threshold for your pool. The minimum value for this is usually 10 GRF.<br/><br/>To change your payment threshold, click the wrench after you login via \"Login\" button on the top right.<br/><br/>You could also adjust your payout threshold to regulate your payout schedule etc daily/weekly etc depending on your hash rate.")
        },
        {
            title: "Getting paid in BTC",
            answer: $sce.trustAsHtml("nodejs-pool supports direct payments to btc. This is done by using the shapeshift API to convert your GRF and send them to a BTC wallet.<br/><br/>To configure BTC payments please have a look at <a href='#/help/getting_started'>Getting Started</a> command line samples.")
        },
        {
            title: "Payments to exchanges/markets?",
            answer: $sce.trustAsHtml("Direct payment to exchange / pool wallets are supported. The only primary difference when using this method is that the minimum payout threshold is higher and usually a defaults to 10GRF.")
        },
        {
            title: "IP Banning?",
        ...
        {
            title: "Hardware?",
            answer: $sce.trustAsHtml("GRAFT is an AISC resistant cryptocurrency, that means it should be cost prohibitive to mine GRAFT with an FGPA/AISC allowing desktop grade hardware to keep its share in the network hashrate and earnings.<br/><br/><a href='http://GRAFTbechmarks.byethost5.com/' target='_new'>http://GRAFTbechmarks.byethost5.com/</a> is a list of community collected hashrate results ordered by hardware, but be careful as some entries may not be accurate.")
        },
        {
            title: "Software?",
        ...
        },
        {
            ...
            answer: $sce.trustAsHtml("<a href='http://reddit.com/r/GRAFTmining' target='_new'>http://reddit.com/r/GRAFTmining/</a><br/><a href='http://GRAFT.stackexchange.com/' target='_new'>http://GRAFT.stackexchange.com/</a>")
        }
        ]
    }
